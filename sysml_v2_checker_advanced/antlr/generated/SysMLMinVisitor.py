...
class SysMLMinVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SysMLMinParser#sendActionNamedBody.
    def visitSendActionNamedBody(self, ctx:SysMLMinParser.SendActionNamedBodyContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SysMLMinParser#metadataRefExpr.
    def visitMetadataRefExpr(self, ctx:SysMLMinParser.MetadataRefExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SysMLMinParser#allSelectionExpr.
    def visitAllSelectionExpr(self, ctx:SysMLMinParser.AllSelectionExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SysMLMinParser#filterStmt.
    def visitFilterStmt(self, ctx:SysMLMinParser.FilterStmtContext):
        return self.visitChildren(ctx)
